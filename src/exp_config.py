...
class ExpConfig:
    ...
    NUM_EPOCH = 150
    BATCH_SIZE = 32
    INITIAL_LEARNING_RATE = 0.9 # initial learning rate, note the we use AdaDelta, so the initial value doe not matter much

    # Network parameters
    CLIP_GRADIENTS = True # whether to perform gradient clipping
    MAX_GRADIENT_NORM = 5.0 # Clip gradients to this norm
    TARGET_EMBEDDING_SIZE = 128 # embedding dimension for each target
    ...
    TARGET_VOCAB_SIZE = 2160+3 # 0: PADDING, 1: GO, 2: EOS, >2: 0-9, a-z
